...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack'}
  ...
  elseif _G.FastAttackZueszYTB_Mode == "Super Fast Attack" then
    ...
    spawn(function()
        ...
        local ToggleCandy = Tabs.Main:AddToggle("ToggleCandy", {Title = "Auto Farm Candy ( Only Max Level )",Description = "Cày Kẹo ( Chỉ Cấp Độ Tối Đa )", Default = false }) ToggleCandy:OnChanged(function(Value)
           _G.AutoCandy = Value
           if Value == false then
            wait()
...
local ToggleChest = Tabs.Main:AddToggle("ToggleChest", {
    Title = "Auto Farm chest [Stops if you get an item]",
    Description = "", 
    Default = false })
...
local Mastery = Tabs.Main:AddSection("Mastery Farm")
    local DropdownMastery = Tabs.Main:AddDropdown("DropdownMastery", {
        Title = "Select Mastery Farm Mode",
        Description = "",
...
local boss = Tabs.Main:AddSection("Farm Boss")
  ...
  local ToggleAutoFarmBoss = Tabs.Main:AddToggle("ToggleAutoFarmBoss", {
    ...
    spawn(function()
      ...
      local ToggleEspKitsune = Tabs.Main:AddToggle("ToggleEspKitsune", {Title = "Kitsune island esp",Description = "", Default = false })
...
if Third_Sea then
    ...
    local ToggleSailBoat = Tabs.Main:AddToggle("ToggleSailBoat", {Title = "Buy Boat & Auto Sail",Description = "", Default = false })
    ...
    local ToggleTerrorshark = Tabs.Main:AddToggle("ToggleTerrorshark", {Title = " auto kill Terrorshark",Description = "", Default = false })
    ...
    spawn(function()
     ...
     local ToggleShark = Tabs.Main:AddToggle("ToggleShark", {Title = "Auto shark",Description = "", Default = false })
    ...
    local ToggleShip = Tabs.Main:AddToggle("ToggleShip", {Title = "Attack Pirate ships",Description = "", Default = false })
...
while wait() do
    ...
    local ToggleGhostShip = Tabs.Main:AddToggle("ToggleGhostShip", {Title = "Auto Ghost Ship",Description = "",Default = false })
...
spawn(function()
    ...
    local AutoElite = Tabs.Main:AddSection("Auto Elite")
...
ToggleAutoW:OnChanged(function(Value)
 ...
 spawn(function()
    ...
    local AutoMysticIsland = Tabs.Main:AddSection("Mirage")
...
local ToggleTweenGear = Tabs.Main:AddToggle("ToggleTweenGear", {Title = "Go to Gear",Description = "", Default = false })
...
spawn(function()
    ...
    local Togglelockmoon = Tabs.Main:AddToggle("Togglelockmoon", {Title = "Auto look at the Moon",Description = "", Default = false })
...
local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "Auto Mirage",Description = "", Default = false })
ToggleMirage:OnChanged(function(Value)
 ...
 local AutoW = Tabs.Main:AddToggle("AutoW", {Title = "Auto W",Description = "", Default = false })
...
if Second_Sea then
        ...
        if Third_Sea then
    local ToggleCakeV2 = Tabs.Main:AddToggle("ToggleCakeV2", {Title = "Auto Cake King",Description = "", Default = false })
...
local ToggleMelee = Tabs.Stats:AddToggle("ToggleMelee", {Title = "Auto stat Melee",Description = "", Default = false })
...
local ToggleDe = Tabs.Stats:AddToggle("ToggleDe", {Title = "Auto stat defense",Description = "", Default = false })
...
local ToggleSword = Tabs.Stats:AddToggle("ToggleSword", {Title = "Auto stat sword",Description = "", Default = false })
...
local ToggleGun = Tabs.Stats:AddToggle("ToggleGun", {Title = "Auto Stat gun", Description = "",Default = false })
...
local ToggleFruit = Tabs.Stats:AddToggle("ToggleFruit", {Title = "Auto stat Devil Fruit",Description = "", Default = false })
...
local ToggleQuanSat = Tabs.Player:AddToggle("ToggleQuanSat", {Title = "Spectaye Player",Description = "", Default = false })
...
local ToggleFastAttack = Tabs.Player:AddToggle("ToggleFastAttack", {Title = "Fast Attack",Description = "", Default = false })
...
local ToggleShowFov = Tabs.Player:AddToggle("ToggleShowFov", {Title = "show player Fov",Description = "", Default = false })
...
local ToggleAimBotSkill = Tabs.Player:AddToggle("ToggleAimBotSkill", {Title = "Skill Aimbot",Description = "", Default = false })
...
local ToggleSpeedRun = Tabs.Player:AddToggle("ToggleSpeedRun", {Title = "Infinite Ability",Description = "", Default = true })
...
local Teleport = Tabs.Teleport:AddSection("Seas")
...
local Mastery = Tabs.Teleport:AddSection("Islands")
...
local ToggleFruit = Tabs.Fruit:AddToggle("ToggleFruit", {Title = "Buy Selected Fruit",Description = "", Default = false })
ToggleFruit:OnChanged(function(Value)
...
local ToggleEspPlayer = Tabs.Fruit:AddToggle("ToggleEspPlayer", {Title = "Player Esp",Description = "", Default = false })
...
local ToggleEspFruit = Tabs.Fruit:AddToggle("ToggleEspFruit", {Title = "Fruit Esp",Description = "", Default = false })
...
local ToggleEspIsland = Tabs.Fruit:AddToggle("ToggleEspIsland", {Title = "Island Eap",Description = "", Default = false })
...
local ToggleEspFlower = Tabs.Fruit:AddToggle("ToggleEspFlower", {Title = "Flower ESP",Description = "", Default = false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "Grab Fruit Under 1M Beli",Description = "", Default = false })
...
local ToggleHumanandghoul = Tabs.Race:AddToggle("ToggleHumanandghoul", {Title = "Kill Aura",Description = "", Default = false })
...
local ToggleAutotrial = Tabs.Race:AddToggle("ToggleAutotrial", {Title = "Auto Quest Race",Description = "", Default = false })
...
local ToggleAutoAcientQuest = Tabs.Race:AddToggle("ToggleAutoAcientQuest", {Title = "Farm & Auto Race Ability",Description = "", Default = false })
...
local ToggleRandomBone = Tabs.Shop:AddToggle("ToggleRandomBone", {Title = "Auto random bone",Description = "", Default = false })
...
if First_Sea or Second_Sea then
    local Mastery = Tabs.Hop:AddSection("You must be on 3rd sea!!")
end

if Third_Sea then
local ToggleFindMoon = Tabs.Hop:AddToggle("ToggleFindMoon", {Title = "Find Moon",Description = "", Default = false })
...
spawn(function()
    while wait() do
        ...
        if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=16137232629" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=16137232629" then
            wait(2.0)
...
local SettingFarm = Tabs.Setting:AddSection("Farming")
 ...
 local ToggleBringMob = Tabs.Setting:AddToggle("ToggleBringMob", {Title = "Bring Mob",Description = "", Default = true })
    ...
    local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "Bypass TP",Description = "", Default = false })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Remove Damage Text",Description = "", Default = true })
